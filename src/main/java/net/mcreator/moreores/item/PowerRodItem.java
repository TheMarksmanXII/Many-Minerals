...
public class PowerRodItem extends MoreOresModElements.ModElement {
	@ObjectHolder("more_ores:power_rod")
	public static final Item block = null;
	public PowerRodItem(MoreOresModElements instance) {
		super(instance, 15);
	}
